  ...
  return (
    <footer className="bg-[#001F4E] text-white py-16 mt-20">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
        ...
        <div className={rtl ? "text-right" : "text-left"}>
          <h2 className="text-2xl font-bold mb-4">{t("companyName")}</h2>
          <p className="text-sm opacity-80 leading-relaxed">{t("aboutText")}</p>
          <div className={`flex mt-6 ${rtl ? "space-x-reverse space-x-4" : "space-x-4"}`}>
            <a href="#" className="hover:opacity-80"><Facebook size={20} /></a>
            <a href="#" className="hover:opacity-80"><Instagram size={20} /></a>
            <a href="#" className="hover:opacity-80"><Linkedin size={20} /></a>
        ...
        <div className={rtl ? "text-right" : "text-left"}>
          <h3 className="text-xl font-semibold mb-4">{t("contactUs")}</h3>
          <ul className="space-y-4 opacity-90 text-sm">
            <li className={`flex items-start gap-2 rtl:gap-2`}>
              <Phone size={18} />
              <span>{t("phone")}</span>
            </li>
            <li className={`flex items-start gap-2 rtl:gap-2`}>
        ...
        <div className={rtl ? "text-right" : "text-left"}>
          <h3 className="text-xl font-semibold mb-4">{t("newsletter")}</h3>
          <p className="text-sm opacity-80 mb-4">{t("newsletterText")}</p>
          <div className={`flex flex-col sm:flex-row w-full gap-2 sm:gap-0 ${rtl ? "sm:flex-row-reverse" : ""}`}>
            <input
              type="email"
              placeholder={t("emailPlaceholder")}
              className="flex-1 px-4 py-3 text-black outline-none rounded-xl w-full"
            />
            <button className="px-4 py-3 bg-blue-600 hover:bg-blue-700 transition font-semibold rounded-xl w-full sm:w-auto">
              {t("subscribe")}
            </button>
          </div>
        </div>
